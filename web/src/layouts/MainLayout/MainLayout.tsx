...
const MainLayout = ({ children }: MainLayoutProps) => {
  return (
    <>
      <section
        className="fixed w-full z-10 bg-orange-50 text-orange-900 border-b border-orange-300"
                          ...
                          <Popover.Panel className="absolute z-10 w-96 max-w-sm px-4 mt-3 transform -translate-x-1/2 left-1/2 sm:px-0 lg:max-w-3xl">
                            <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                              <div className="relative grid gap-8 bg-white p-7 lg:grid-rows-2">
                                ...
                                >
                                  <div className="flex items-center justify-center flex-shrink-0 w-10 h-10 bg-orange-200 rounded-lg sm:h-12 sm:w-12">
                                  ...
                                  <div className="ml-4">
                                    ...
                                    <p className="text-xs text-stone-500 font-normal">
                                      Learn all the features of Redwood with
                                ...
                                >
                                  ...
                                  <div className="ml-4">
                                    ...
                                    <p className="text-xs text-stone-500 font-normal">
                                      Case studies of real-world apps and
                                      companies built with Redwood
                                    </p>
                                  </div>
                                </Link>
                              </div>
                            ...
                            <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                              <div className="relative grid gap-8 bg-white p-7 lg:grid-rows-2">
                                <Link
                                  ...
                                  className="flex items-center p-2 -m-3 transition duration-150 ease-in-out rounded-lg hover:bg-stone-50 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50 no-underline"
                                >
                                  <div className="flex items-center justify-center flex-shrink-0 p-2 w-10 h-10 bg-orange-200 rounded-lg sm:h-12 sm:w-12">
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      viewBox="0 0 32 32"
                                      className="transition duration-200 fill-current text-orange-600 hover:text-orange-700"
                                    >
                                  ...
                                  <div className="ml-4">
                                    ...
                                    <p className="text-xs text-stone-500 font-normal">
                                      Long-form discussions about Redwood,
                                      troubleshooting, show & tell
                                    </p>
                                  </div>
                                </Link>
                                ...
                                <Link
                                  ...
                                  className="flex items-center p-2 -m-3 transition duration-150 ease-in-out rounded-lg hover:bg-stone-50 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50 no-underline"
                                >
                                  <div className="flex items-center justify-center flex-shrink-0 w-10 h-10 p-2 bg-orange-200 rounded-lg sm:h-12 sm:w-12">
                                    <svg
                                      viewBox="0 0 36 36"
                                      className="fill-current text-orange-600 hover:text-orange-700"
                                      xmlns="http://www.w3.org/2000/svg"
                                    >
                                  ...
                                  <div className="ml-4">
                                    ...
                                    <p className="text-xs text-stone-500 font-normal">
                                      Watercooler, relationship building, quick
                                      discussion and help
                                    </p>
                                  </div>
                                </Link>
                                ...
                                >
                                  ...
                                  <div className="ml-4">
                                    ...
                                    <p className="text-xs text-stone-500 font-normal">
                                      Follow @redwoodjs for updates, new
                                      releases and community meetup annoucements
                                    </p>
                                  </div>
                                </Link>
                              </div>
              ...
              <ul className="hidden lg:flex items-center">
                ...
                <li className="mr-3">
                  ...
                  >
                    <svg
                      viewBox="0 0 32 32"
                      className="transition duration-200 fill-current text-orange-400 hover:text-orange-700"
                      xmlns="http://www.w3.org/2000/svg"
                    >
      ...
      <footer className="p-6 bg-orange-100 text-orange-700 text-sm border-t border-orange-300">
