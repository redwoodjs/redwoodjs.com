            ...
            <ul className="hidden lg:flex items-center">
              ...
              <li className="mr-3">
                ...
                >
                  <svg
                    viewBox="0 0 32 32"
                    className="transition duration-200 fill-current text-red-400 hover:text-red-700"
                    xmlns="http://www.w3.org/2000/svg"
                  >
              ...
              <li className="mx-2">
                <a
                  ...
                  title="Go to Redwood's Twitter page"
                >
                  <svg
                    viewBox="0 0 34 34"
                    className="transition duration-200 fill-current text-red-400 hover:text-red-700"
              ...
              <li className="mx-2 relative tooltip">
                <a
                  className="block w-6"
                  href="https://community.redwoodjs.com"
                ...
                <div className="hidden tooltip-text absolute w-48 mt-2 -mr-1 text-white bg-red-700 text-xs rounded py-2 px-3 right-0">
                  <strong>Discourse Forums</strong>
                  <br />
                  Long-form discussions about Redwood, troubleshooting, show &
                  tell
                  <svg
                    className="absolute text-red-700 h-2 right-0 mr-3 bottom-full"
                    x="0px"
                    y="0px"
                    viewBox="0 0 255 255"
                    xmlSpace="preserve"
                  >
                    <polygon
                      ...
                      points="255,255 127.5,127.5 0,255"
                    />
                  </svg>
                </div>
              </li>

              <li className="ml-2 relative tooltip">
                <a
                  className="block w-6"
                ...
                >
                  ...
                  <div className="hidden tooltip-text absolute w-48 mt-2 -mr-1 text-white bg-red-700 text-xs rounded py-2 px-3 right-0">
                    ...
                    <br />
                    Watercooler, relationship building, quick discussion
                    <svg
                      className="absolute text-red-700 h-2 right-0 mr-3 bottom-full"
                      x="0px"
                      y="0px"
