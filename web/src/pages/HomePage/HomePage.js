...
const HomePage = () => {
  ...
  return (
    <>
      <MetaTags
        title="Home"
        description="The fullstack JS framework for startups"
      />
      ...
      <Hero
        ...
        text={
          <Trans
            i18nKey={'HomePage.hero.text'}
            components={{
              strong: <span className="text-red-100 font-semibold" />,
            }}
          />
        }
        links={[
          {
            pointer: t('HomePage.hero.links.tutorial'),
            href: 'https://learn.redwoodjs.com/docs/tutorial/welcome-to-redwood',
            className: 'button',
          },
          {
            pointer: t('HomePage.hero.links.docs'),
      ...
      <section className="py-6 md:py-8 lg:flex justify-between items-start px-8 h-72 md:h-64">
        <div className="glide max-w-screen-lg mx-auto h-full">
          <div className="glide__track h-full" data-glide-el="track">
            <ul className="glide__slides h-full title">Testimonials</ul>
          </div>
          ...
          >
            <button
              className="absolute left-0 glide__arrow glide__arrow--left text-6xl text-red-300 hover:text-red-400 transition:color duration-100 focus:outline-none"
              data-glide-dir="<"
            >
              &laquo;
            </button>
            <button
              className="absolute right-0 glide__arrow glide__arrow--right text-6xl text-red-300 hover:text-red-400 transition:color duration-100 focus:outline-none"
              data-glide-dir=">"
            >
              &raquo;
            </button>
      ...
      <section className="md:flex items-start max-w-screen-xl mx-auto px-8 my-16 space-x-12">
        <div className="md:w-1/3">
          ...
          >
            <input
              ...
              value=""
              name="EMAIL"
              className="block text-right border border-teal-600 rounded-l py-3 px-2 w-full placeholder:text-stone-300"
              id="mce-EMAIL"
            ...
            <button
              ...
              value="Subscribe"
              name="subscribe"
              className="block bg-teal-600 hover:bg-teal-500 transition duration-200 text-white px-4 py-3 border border-teal-600 font-semibold rounded-r"
            >
              Subscribe
            </button>
          </form>
        ...
        <div className="md:w-1/3 mt-8 md:mt-0">
          <header className="text-center">
            <a href="/stickers.html" className="no-underline">
              <h2 className="title">
                Get Some Swag
              </h2>
            </a>
      ...
      */}
      ...
      <section className="py-12 bg-red-200 px-8">
        <div className="lg:flex justify-between items-start max-w-screen-xl mx-auto space-x-8">
          <div className="flex flex-col md:flex-row lg:flex-col justify-between lg:w-1/3 text-center">
            ...
            <div className="ml-0 md:ml-8 lg:ml-0 text-center md:text-left lg:text-center w-full">
              ...
              <p className="lg:mt-4 px-2 text-red-800">
                ...
                <span className="whitespace-no-wrap">Edge—</span>CDNs and
                serverless functions distributed everywhere. Containers and
                traditional server deploys are also supported!
              </p>
              <p></p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row lg:flex-col justify-between lg:w-1/3 text-center mt-8 md:mt-4 lg:mt-0">
            <img
              src="/images/icon-organization.svg"
            ...
            <div className="ml-0 md:ml-8 lg:ml-0 text-center md:text-left lg:text-center w-full">
              ...
              <p className="lg:mt-4 px-2 text-red-800">
                ...
                back-end. Components, layouts, pages, GraphQL, and services:
                they all have a home. Don't worry, you can reogranize if you
                want.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row lg:flex-col justify-between lg:w-1/3 text-center mt-8 md:mt-4 lg:mt-0">
            ...
            <div className="ml-0 md:ml-8 lg:ml-0 text-center md:text-left lg:text-center w-full">
              ...
              <p className="lg:mt-4 px-2 text-red-800">
                ...
                Let us worry about Webpack and Babel config, you focus on the
                fun stuff.
              </p>
            </div>
          </div>
        ...
        <div className="md:w-3/5 md:pl-4 mt-4 md:mt-0 ">
          <a href="/images/structure.png">
            <img
              ...
              alt="Structure of a Redwood app"
      ...
      <section className="md:flex mt-36 max-w-screen-lg mx-auto">
        <div className="md:w-3/5 md:pr-4 mt-4 md:mt-0">
          <Highlight className="javascript overflow-x-scroll text-xs border bg-white border-red-200 rounded-lg p-4">
            {`// web/src/Routes.js
    ...
    <Link to={routes.users({type: "admin"})}>View Admins</Link>
        ...
        <div className="md:w-2/5 pl-4">
          ...
          <p className="my-3">
            ...
            <strong className="text-teal-700">Named routes</strong> let you
            reference a route by a name you define,{' '}
            <strong className="text-teal-700">route param types</strong> take
            care of coercing values based on data type or custom functions,{' '}
            <span className="whitespace-nowrap">and more.</span>
          </p>
          <p className="">
            <a href="https://redwoodjs.com/docs/routing">
      ...
      <section className="md:flex mt-36 max-w-screen-lg mx-auto">
        <div className="md:w-2/5 pr-4 text-right">
          ...
          <p className="my-3">
            We call them <strong className="text-teal-700">cells</strong> and
            they contain the GraphQL query, loading, empty, error, and success
            states, each one rendering itself automatically depending on what
            state your cell <span className="whitespace-nowrap">is in.</span>
          </p>
          <p className="">
            <a href="https://redwoodjs.com/docs/routing">
...
\``}
          ...
          <Highlight className="javascript mt-2 overflow-x-scroll text-xs border bg-white border-red-200 rounded-lg p-4">
  ...
  return JSON.stringify(users)
        ...
        <div className="md:w-2/5 pl-4">
          ...
          <p className="my-3">
            ...
            <strong className="text-teal-700">Services</strong>. These can be
            used by your GraphQL API or any other place in your backend code.
            Redwood does all of the annoying stuff{' '}
            <span className="whitespace-nowrap">for you.</span>
          </p>
          <p className="my-3">
      ...
      <section className="md:flex mt-36 max-w-screen-lg mx-auto">
        <div className="md:w-2/5 pr-4 text-right">
          <h3 className="title">CLI Tools</h3>
          <p className="my-3">
          ...
          <p className="my-3">
            Redwood contains several{' '}
            <strong className="text-teal-700">generators</strong> which create
            the shell of cells, pages, layouts, services, as well as{' '}
            <strong className="text-teal-700">installers</strong> for
            TailwindCSS, authentication libraries and even{' '}
            <span className="whitespace-nowrap">deploy targets.</span>
          </p>
          <p className="">
            <a href="https://redwoodjs.com/docs/routing">Read more the CLI</a>
          </p>
        </div>
        <div className="md:w-3/5 md:pl-4 mt-4 md:mt-0">
          <Highlight className="bash overflow-x-scroll text-xs border bg-white border-red-200 rounded-lg p-4">
...
export const Comment = () => {
  ...
  return (
    <Form onSubmit={onSubmit}>
      ...
      <section
        className="mt-24 py-36 text-center bg-red-800"
        style={{
          backgroundImage:
