          ...
          <section className="flex flex-col space-y-8">
            ...
            <section className="flex flex-col space-y-6">
              ...
              <Spoiler title="What problem are you addressing?">
                ...
                sem. Praesent vel nibh a lectus fermentum bibendum. Mauris quis
                leo ac nulla pellentesque suscipit.
              </Spoiler>
              <Spoiler title="What solution are you bringing?">
                ...
                aliquet ultricies mi non interdum. Duis at mi odio. Praesent vel
                mi sit amet erat malesuada efficitur ut vestibulum nunc. Nulla
                est urna, mollis ac ultrices nec, lacinia ut ipsum. Vivamus
                aliquam velit sed nibh semper cursus.
              </Spoiler>
            </section>
            <section className="flex flex-col space-y-6">
              <div className="space-y-1">
                ...
                <p className="text-sm text-stone-500">
                  How has RedwoodJS impacted this project, how is it being used,
                  what are the creator&apos;s thoughts on it?
                </p>
              </div>
            ...
            <section className="flex flex-col space-y-6">
              <div className="space-y-1">
                ...
                <p className="text-sm text-stone-500">
                  RedwoodJS <i>is</i> its community — so how has this community
                  played a role in the author&apos;s project? Has it contributed
                  to its success?
                </p>
              </div>
